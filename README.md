...
- [2019] Learning a Compressed Sensing Measurement Matrix via Gradient Unrolling, ICM L[[Paper](https://proceedings.mlr.press/v97/wu19b.html)]
...
## Others
- [2021] DeepSIC: Deep Soft Interference Cancellation for Multiuser MIMO Detection, IEEE TWC [[Paper](https://ieeexplore.ieee.org/abstract/document/9242305)]
- [2020] Adaptive Ultrasound Beamforming Using Deep Learning, IEEE TCI [[Paper](https://ieeexplore.ieee.org/abstract/document/9138451)]
